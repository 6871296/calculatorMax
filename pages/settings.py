...
def main(root:Tk):
    ...
    maliang.Text(cv,(10,10),text='设置',fontsize=24)
    sw=Switch(cv,(20,50),40,default=settings.get('ignoreClipboardOverwritingWarning'),command=lambda e:settings.set('ignoreClipboardOverwritingWarning',e))
